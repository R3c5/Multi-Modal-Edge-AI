...
class HyperparameterConfig:
    def __init__(self, batch_size: int = 32, reconstruction_error_quantile: float = 0.99,
                 anomaly_generation_ratio: float = 0.1,
                 clean_test_data_ratio: float = 0.3, anomaly_whisker: float = 1.5, learning_rate: float = 0.01,
                 ...
                 n_epochs: int = 10, window_size: float = 10, window_slide: float = 5, event_based=True, one_hot=True):
