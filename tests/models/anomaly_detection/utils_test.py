...
from multi_modal_edge_ai.models.anomaly_detection.utils import isolate_adl_in_dataframe, dataloader_to_numpy


def load_datasets():
    return {
        "adl_df": combine_equal_consecutive_activities(
            parse_file_with_idle("tests/models/anomaly_detection/dummy_datasets/dummy_adl_windowing_test.csv")),
        "adl_df_all_other": combine_equal_consecutive_activities(parse_file_with_idle(
            "tests/models/anomaly_detection/dummy_datasets/dummy_adl_check_squashed_adl_isolation1.csv")),
        "adl_df_mixed": combine_equal_consecutive_activities(parse_file_with_idle(
            "tests/models/anomaly_detection/dummy_datasets/dummy_adl_check_squashed_adl_isolation2.csv"))
    }
